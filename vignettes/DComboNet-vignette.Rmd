...
<div style = "width:120%; height:auto; margin: auto;">
<p style="text-indent:16px;">Before start any prediction assignment, please make sure `data` folder is fully downloaded and put in a fetchable path. `data` folder contains data files for construct networks as well as testing datasets used in our publication.</p>
